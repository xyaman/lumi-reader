...
export function Navbar(props: SectionProps) {
    ...
    return (
        ...
        >
            <nav
                class="bg-base01 text-base01 top-0 left-0 w-full h-14 backdrop-blur-md shadow-md px-4 z-30 flex items-center justify-between transition-all duration-300"
        ...
        <>
            ...
            <Show when={!navbar?.disableCollapse}>
                <Portal>
                    ...
                    {/* Slide-in menu */}
                    <div
                        class="bg-base01 text-base01 fixed top-0 left-0 h-screen w-64 z-[100] transition-transform duration-300 ease-in-out md:hidden"
                        classList={{
                    ...
                    >
                        <div class="flex flex-col h-full p-4">
                            ...
                            {/* Menu items */}
                            <div class="bg-base01 text-base01 mt-6 flex flex-col space-y-4">{props.children}</div>
                        </div>
                    </div>
                </Portal>
            </Show>
